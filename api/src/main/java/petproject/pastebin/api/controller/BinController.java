...
public class BinController {
    ...
    @Autowired
    private S3BinService yandexService;

    @PostMapping()
    public String post(BinDto body) {return yandexService.create(body);}

    @GetMapping("/{key}")
    public BinDto get(@PathVariable String key) {return yandexService.get(key);}
